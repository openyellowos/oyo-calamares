...
static constexpr auto qt_meta_stringdata_ZN20CalamaresApplicationE = QtMocHelpers::stringData(
...
Q_CONSTINIT static const uint qt_meta_data_ZN20CalamaresApplicationE[] = {
...
Q_CONSTINIT const QMetaObject CalamaresApplication::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN20CalamaresApplicationE.offsetsAndSizes,
    qt_meta_data_ZN20CalamaresApplicationE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN20CalamaresApplicationE_t,
        // Q_OBJECT / Q_GADGET
...
void *CalamaresApplication::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN20CalamaresApplicationE.stringdata0))
