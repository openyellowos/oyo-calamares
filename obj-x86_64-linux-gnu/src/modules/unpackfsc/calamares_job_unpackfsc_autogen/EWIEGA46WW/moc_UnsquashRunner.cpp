...
static constexpr auto qt_meta_stringdata_ZN14UnsquashRunnerE = QtMocHelpers::stringData(
    "UnsquashRunner",
    "unsquashProgress",
    "",
    "line"
...
Q_CONSTINIT static const uint qt_meta_data_ZN14UnsquashRunnerE[] = {
...
Q_CONSTINIT const QMetaObject UnsquashRunner::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN14UnsquashRunnerE.offsetsAndSizes,
    qt_meta_data_ZN14UnsquashRunnerE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN14UnsquashRunnerE_t,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<UnsquashRunner, std::true_type>,
        // method 'unsquashProgress'
...
void *UnsquashRunner::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN14UnsquashRunnerE.stringdata0))
