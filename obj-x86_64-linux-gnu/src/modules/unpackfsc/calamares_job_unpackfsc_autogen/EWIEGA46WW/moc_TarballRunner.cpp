...
static constexpr auto qt_meta_stringdata_ZN13TarballRunnerE = QtMocHelpers::stringData(
    "TarballRunner",
    "tarballProgress",
    "",
    "line"
...
Q_CONSTINIT static const uint qt_meta_data_ZN13TarballRunnerE[] = {
...
Q_CONSTINIT const QMetaObject TarballRunner::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN13TarballRunnerE.offsetsAndSizes,
    qt_meta_data_ZN13TarballRunnerE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN13TarballRunnerE_t,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<TarballRunner, std::true_type>,
        // method 'tarballProgress'
...
void *TarballRunner::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN13TarballRunnerE.stringdata0))
