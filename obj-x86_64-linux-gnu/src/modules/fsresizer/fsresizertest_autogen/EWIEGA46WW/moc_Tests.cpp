...
static constexpr auto qt_meta_stringdata_ZN14FSResizerTestsE = QtMocHelpers::stringData(
    "FSResizerTests",
    "initTestCase",
    "",
...
Q_CONSTINIT static const uint qt_meta_data_ZN14FSResizerTestsE[] = {
...
Q_CONSTINIT const QMetaObject FSResizerTests::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN14FSResizerTestsE.offsetsAndSizes,
    qt_meta_data_ZN14FSResizerTestsE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN14FSResizerTestsE_t,
        // Q_OBJECT / Q_GADGET
...
void *FSResizerTests::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN14FSResizerTestsE.stringdata0))
