...
static constexpr auto qt_meta_stringdata_ZN11ResizeFSJobE = QtMocHelpers::stringData(
    "ResizeFSJob"
);
...
Q_CONSTINIT static const uint qt_meta_data_ZN11ResizeFSJobE[] = {
...
Q_CONSTINIT const QMetaObject ResizeFSJob::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN11ResizeFSJobE.offsetsAndSizes,
    qt_meta_data_ZN11ResizeFSJobE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN11ResizeFSJobE_t,
        // Q_OBJECT / Q_GADGET
...
void *ResizeFSJob::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN11ResizeFSJobE.stringdata0))
...
#ifdef QT_MOC_HAS_STRINGDATA
static constexpr auto qt_meta_stringdata_ZN18ResizeFSJobFactoryE = QtMocHelpers::stringData(
    "ResizeFSJobFactory"
);
#else  // !QT_MOC_HAS_STRINGDATA
#error "qtmochelpers.h not found or too old."
...
Q_CONSTINIT static const uint qt_meta_data_ZN18ResizeFSJobFactoryE[] = {
...
Q_CONSTINIT const QMetaObject ResizeFSJobFactory::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN18ResizeFSJobFactoryE.offsetsAndSizes,
    qt_meta_data_ZN18ResizeFSJobFactoryE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN18ResizeFSJobFactoryE_t,
        // Q_OBJECT / Q_GADGET
...
{
    if (!_clname) return nullptr;
    if (!strcmp(_clname, qt_meta_stringdata_ZN18ResizeFSJobFactoryE.stringdata0))
        return static_cast<void*>(this);
