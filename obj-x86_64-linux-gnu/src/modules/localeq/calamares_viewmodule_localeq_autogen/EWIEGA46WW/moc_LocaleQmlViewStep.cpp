...
static constexpr auto qt_meta_stringdata_ZN17LocaleQmlViewStepE = QtMocHelpers::stringData(
    "LocaleQmlViewStep"
);
...
Q_CONSTINIT static const uint qt_meta_data_ZN17LocaleQmlViewStepE[] = {
...
Q_CONSTINIT const QMetaObject LocaleQmlViewStep::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN17LocaleQmlViewStepE.offsetsAndSizes,
    qt_meta_data_ZN17LocaleQmlViewStepE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN17LocaleQmlViewStepE_t,
        // Q_OBJECT / Q_GADGET
...
void *LocaleQmlViewStep::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN17LocaleQmlViewStepE.stringdata0))
...
#ifdef QT_MOC_HAS_STRINGDATA
static constexpr auto qt_meta_stringdata_ZN24LocaleQmlViewStepFactoryE = QtMocHelpers::stringData(
...
Q_CONSTINIT static const uint qt_meta_data_ZN24LocaleQmlViewStepFactoryE[] = {
...
Q_CONSTINIT const QMetaObject LocaleQmlViewStepFactory::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN24LocaleQmlViewStepFactoryE.offsetsAndSizes,
    qt_meta_data_ZN24LocaleQmlViewStepFactoryE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN24LocaleQmlViewStepFactoryE_t,
        // Q_OBJECT / Q_GADGET
...
{
    if (!_clname) return nullptr;
    if (!strcmp(_clname, qt_meta_stringdata_ZN24LocaleQmlViewStepFactoryE.stringdata0))
        return static_cast<void*>(this);
