...
static constexpr auto qt_meta_stringdata_ZN11LicensePageE = QtMocHelpers::stringData(
    "LicensePage",
    "nextStatusChanged",
    "",
    "status",
...
Q_CONSTINIT static const uint qt_meta_data_ZN11LicensePageE[] = {
...
Q_CONSTINIT const QMetaObject LicensePage::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN11LicensePageE.offsetsAndSizes,
    qt_meta_data_ZN11LicensePageE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN11LicensePageE_t,
        // Q_OBJECT / Q_GADGET
...
void LicensePage::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        ...
        {
            using _q_method_type = void (LicensePage::*)(bool );
            if (_q_method_type _q_method = &LicensePage::nextStatusChanged; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
void *LicensePage::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN11LicensePageE.stringdata0))
