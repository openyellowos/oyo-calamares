...
static constexpr auto qt_meta_stringdata_ZN12PackageModelE = QtMocHelpers::stringData(
    "PackageModel"
);
...
Q_CONSTINIT static const uint qt_meta_data_ZN12PackageModelE[] = {
...
Q_CONSTINIT const QMetaObject PackageModel::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN12PackageModelE.offsetsAndSizes,
    qt_meta_data_ZN12PackageModelE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN12PackageModelE_t,
        // Q_OBJECT / Q_GADGET
...
void *PackageModel::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN12PackageModelE.stringdata0))
