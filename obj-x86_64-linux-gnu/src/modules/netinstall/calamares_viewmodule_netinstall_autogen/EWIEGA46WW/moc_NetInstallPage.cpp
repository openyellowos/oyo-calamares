...
static constexpr auto qt_meta_stringdata_ZN14NetInstallPageE = QtMocHelpers::stringData(
    "NetInstallPage"
);
...
Q_CONSTINIT static const uint qt_meta_data_ZN14NetInstallPageE[] = {
...
Q_CONSTINIT const QMetaObject NetInstallPage::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN14NetInstallPageE.offsetsAndSizes,
    qt_meta_data_ZN14NetInstallPageE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN14NetInstallPageE_t,
        // Q_OBJECT / Q_GADGET
...
void *NetInstallPage::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN14NetInstallPageE.stringdata0))
