...
static constexpr auto qt_meta_stringdata_ZN18NetInstallViewStepE = QtMocHelpers::stringData(
    "NetInstallViewStep",
    "nextIsReady",
    ""
);
...
Q_CONSTINIT static const uint qt_meta_data_ZN18NetInstallViewStepE[] = {
...
Q_CONSTINIT const QMetaObject NetInstallViewStep::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN18NetInstallViewStepE.offsetsAndSizes,
    qt_meta_data_ZN18NetInstallViewStepE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN18NetInstallViewStepE_t,
        // Q_OBJECT / Q_GADGET
...
void *NetInstallViewStep::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN18NetInstallViewStepE.stringdata0))
...
#ifdef QT_MOC_HAS_STRINGDATA
static constexpr auto qt_meta_stringdata_ZN25NetInstallViewStepFactoryE = QtMocHelpers::stringData(
...
Q_CONSTINIT static const uint qt_meta_data_ZN25NetInstallViewStepFactoryE[] = {
...
Q_CONSTINIT const QMetaObject NetInstallViewStepFactory::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN25NetInstallViewStepFactoryE.offsetsAndSizes,
    qt_meta_data_ZN25NetInstallViewStepFactoryE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN25NetInstallViewStepFactoryE_t,
        // Q_OBJECT / Q_GADGET
...
{
    if (!_clname) return nullptr;
    if (!strcmp(_clname, qt_meta_stringdata_ZN25NetInstallViewStepFactoryE.stringdata0))
        return static_cast<void*>(this);
