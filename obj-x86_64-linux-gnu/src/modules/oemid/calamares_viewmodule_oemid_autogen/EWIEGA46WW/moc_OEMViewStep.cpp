...
static constexpr auto qt_meta_stringdata_ZN11OEMViewStepE = QtMocHelpers::stringData(
    "OEMViewStep"
);
...
Q_CONSTINIT static const uint qt_meta_data_ZN11OEMViewStepE[] = {
...
Q_CONSTINIT const QMetaObject OEMViewStep::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN11OEMViewStepE.offsetsAndSizes,
    qt_meta_data_ZN11OEMViewStepE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN11OEMViewStepE_t,
        // Q_OBJECT / Q_GADGET
...
void *OEMViewStep::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN11OEMViewStepE.stringdata0))
...
#ifdef QT_MOC_HAS_STRINGDATA
static constexpr auto qt_meta_stringdata_ZN18OEMViewStepFactoryE = QtMocHelpers::stringData(
    "OEMViewStepFactory"
);
#else  // !QT_MOC_HAS_STRINGDATA
#error "qtmochelpers.h not found or too old."
...
Q_CONSTINIT static const uint qt_meta_data_ZN18OEMViewStepFactoryE[] = {
...
Q_CONSTINIT const QMetaObject OEMViewStepFactory::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN18OEMViewStepFactoryE.offsetsAndSizes,
    qt_meta_data_ZN18OEMViewStepFactoryE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN18OEMViewStepFactoryE_t,
        // Q_OBJECT / Q_GADGET
...
{
    if (!_clname) return nullptr;
    if (!strcmp(_clname, qt_meta_stringdata_ZN18OEMViewStepFactoryE.stringdata0))
        return static_cast<void*>(this);
