...
static constexpr auto qt_meta_stringdata_ZN5IDJobE = QtMocHelpers::stringData(
    "IDJob"
);
...
Q_CONSTINIT static const uint qt_meta_data_ZN5IDJobE[] = {
...
Q_CONSTINIT const QMetaObject IDJob::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN5IDJobE.offsetsAndSizes,
    qt_meta_data_ZN5IDJobE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN5IDJobE_t,
        // Q_OBJECT / Q_GADGET
...
void *IDJob::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN5IDJobE.stringdata0))
