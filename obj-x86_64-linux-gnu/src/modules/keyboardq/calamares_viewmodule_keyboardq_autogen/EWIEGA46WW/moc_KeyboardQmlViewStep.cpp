...
static constexpr auto qt_meta_stringdata_ZN19KeyboardQmlViewStepE = QtMocHelpers::stringData(
    "KeyboardQmlViewStep"
);
...
Q_CONSTINIT static const uint qt_meta_data_ZN19KeyboardQmlViewStepE[] = {
...
Q_CONSTINIT const QMetaObject KeyboardQmlViewStep::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN19KeyboardQmlViewStepE.offsetsAndSizes,
    qt_meta_data_ZN19KeyboardQmlViewStepE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN19KeyboardQmlViewStepE_t,
        // Q_OBJECT / Q_GADGET
...
void *KeyboardQmlViewStep::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN19KeyboardQmlViewStepE.stringdata0))
...
#ifdef QT_MOC_HAS_STRINGDATA
static constexpr auto qt_meta_stringdata_ZN26KeyboardQmlViewStepFactoryE = QtMocHelpers::stringData(
...
Q_CONSTINIT static const uint qt_meta_data_ZN26KeyboardQmlViewStepFactoryE[] = {
...
Q_CONSTINIT const QMetaObject KeyboardQmlViewStepFactory::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN26KeyboardQmlViewStepFactoryE.offsetsAndSizes,
    qt_meta_data_ZN26KeyboardQmlViewStepFactoryE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN26KeyboardQmlViewStepFactoryE_t,
        // Q_OBJECT / Q_GADGET
...
{
    if (!_clname) return nullptr;
    if (!strcmp(_clname, qt_meta_stringdata_ZN26KeyboardQmlViewStepFactoryE.stringdata0))
        return static_cast<void*>(this);
