...
static constexpr auto qt_meta_stringdata_ZN12SummaryModelE = QtMocHelpers::stringData(
    "SummaryModel"
);
...
Q_CONSTINIT static const uint qt_meta_data_ZN12SummaryModelE[] = {
...
Q_CONSTINIT const QMetaObject SummaryModel::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN12SummaryModelE.offsetsAndSizes,
    qt_meta_data_ZN12SummaryModelE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN12SummaryModelE_t,
        // Q_OBJECT / Q_GADGET
...
void *SummaryModel::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN12SummaryModelE.stringdata0))
