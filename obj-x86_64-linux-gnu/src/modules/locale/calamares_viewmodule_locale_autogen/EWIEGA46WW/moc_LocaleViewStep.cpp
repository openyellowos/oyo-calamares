...
static constexpr auto qt_meta_stringdata_ZN14LocaleViewStepE = QtMocHelpers::stringData(
    "LocaleViewStep",
    "setUpPage",
    ""
);
...
Q_CONSTINIT static const uint qt_meta_data_ZN14LocaleViewStepE[] = {
...
Q_CONSTINIT const QMetaObject LocaleViewStep::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN14LocaleViewStepE.offsetsAndSizes,
    qt_meta_data_ZN14LocaleViewStepE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN14LocaleViewStepE_t,
        // Q_OBJECT / Q_GADGET
...
void *LocaleViewStep::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN14LocaleViewStepE.stringdata0))
...
#ifdef QT_MOC_HAS_STRINGDATA
static constexpr auto qt_meta_stringdata_ZN21LocaleViewStepFactoryE = QtMocHelpers::stringData(
...
Q_CONSTINIT static const uint qt_meta_data_ZN21LocaleViewStepFactoryE[] = {
...
Q_CONSTINIT const QMetaObject LocaleViewStepFactory::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN21LocaleViewStepFactoryE.offsetsAndSizes,
    qt_meta_data_ZN21LocaleViewStepFactoryE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN21LocaleViewStepFactoryE_t,
        // Q_OBJECT / Q_GADGET
...
{
    if (!_clname) return nullptr;
    if (!strcmp(_clname, qt_meta_stringdata_ZN21LocaleViewStepFactoryE.stringdata0))
        return static_cast<void*>(this);
