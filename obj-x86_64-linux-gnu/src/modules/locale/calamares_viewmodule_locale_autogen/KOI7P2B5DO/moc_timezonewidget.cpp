...
static constexpr auto qt_meta_stringdata_ZN14TimeZoneWidgetE = QtMocHelpers::stringData(
    "TimeZoneWidget",
    "locationChanged",
    "",
    "const TimeZoneData*",
...
Q_CONSTINIT static const uint qt_meta_data_ZN14TimeZoneWidgetE[] = {
...
Q_CONSTINIT const QMetaObject TimeZoneWidget::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN14TimeZoneWidgetE.offsetsAndSizes,
    qt_meta_data_ZN14TimeZoneWidgetE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN14TimeZoneWidgetE_t,
        // Q_OBJECT / Q_GADGET
...
void TimeZoneWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        ...
        {
            using _q_method_type = void (TimeZoneWidget::*)(const TimeZoneData * );
            if (_q_method_type _q_method = &TimeZoneWidget::locationChanged; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
void *TimeZoneWidget::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN14TimeZoneWidgetE.stringdata0))
