...
static constexpr auto qt_meta_stringdata_ZN16KeyboardViewStepE = QtMocHelpers::stringData(
    "KeyboardViewStep"
);
...
Q_CONSTINIT static const uint qt_meta_data_ZN16KeyboardViewStepE[] = {
...
Q_CONSTINIT const QMetaObject KeyboardViewStep::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN16KeyboardViewStepE.offsetsAndSizes,
    qt_meta_data_ZN16KeyboardViewStepE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN16KeyboardViewStepE_t,
        // Q_OBJECT / Q_GADGET
...
void *KeyboardViewStep::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN16KeyboardViewStepE.stringdata0))
...
#ifdef QT_MOC_HAS_STRINGDATA
static constexpr auto qt_meta_stringdata_ZN23KeyboardViewStepFactoryE = QtMocHelpers::stringData(
...
Q_CONSTINIT static const uint qt_meta_data_ZN23KeyboardViewStepFactoryE[] = {
...
Q_CONSTINIT const QMetaObject KeyboardViewStepFactory::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN23KeyboardViewStepFactoryE.offsetsAndSizes,
    qt_meta_data_ZN23KeyboardViewStepFactoryE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN23KeyboardViewStepFactoryE_t,
        // Q_OBJECT / Q_GADGET
...
{
    if (!_clname) return nullptr;
    if (!strcmp(_clname, qt_meta_stringdata_ZN23KeyboardViewStepFactoryE.stringdata0))
        return static_cast<void*>(this);
