...
static constexpr auto qt_meta_stringdata_ZN20SetKeyboardLayoutJobE = QtMocHelpers::stringData(
...
Q_CONSTINIT static const uint qt_meta_data_ZN20SetKeyboardLayoutJobE[] = {
...
Q_CONSTINIT const QMetaObject SetKeyboardLayoutJob::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN20SetKeyboardLayoutJobE.offsetsAndSizes,
    qt_meta_data_ZN20SetKeyboardLayoutJobE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN20SetKeyboardLayoutJobE_t,
        // Q_OBJECT / Q_GADGET
...
void *SetKeyboardLayoutJob::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN20SetKeyboardLayoutJobE.stringdata0))
