...
static constexpr auto qt_meta_stringdata_ZN18WelcomeQmlViewStepE = QtMocHelpers::stringData(
    "WelcomeQmlViewStep"
);
...
Q_CONSTINIT static const uint qt_meta_data_ZN18WelcomeQmlViewStepE[] = {
...
Q_CONSTINIT const QMetaObject WelcomeQmlViewStep::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN18WelcomeQmlViewStepE.offsetsAndSizes,
    qt_meta_data_ZN18WelcomeQmlViewStepE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN18WelcomeQmlViewStepE_t,
        // Q_OBJECT / Q_GADGET
...
void *WelcomeQmlViewStep::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN18WelcomeQmlViewStepE.stringdata0))
...
#ifdef QT_MOC_HAS_STRINGDATA
static constexpr auto qt_meta_stringdata_ZN25WelcomeQmlViewStepFactoryE = QtMocHelpers::stringData(
...
Q_CONSTINIT static const uint qt_meta_data_ZN25WelcomeQmlViewStepFactoryE[] = {
...
Q_CONSTINIT const QMetaObject WelcomeQmlViewStepFactory::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN25WelcomeQmlViewStepFactoryE.offsetsAndSizes,
    qt_meta_data_ZN25WelcomeQmlViewStepFactoryE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN25WelcomeQmlViewStepFactoryE_t,
        // Q_OBJECT / Q_GADGET
...
{
    if (!_clname) return nullptr;
    if (!strcmp(_clname, qt_meta_stringdata_ZN25WelcomeQmlViewStepFactoryE.stringdata0))
        return static_cast<void*>(this);
