...
static constexpr auto qt_meta_stringdata_ZN17ShellProcessTestsE = QtMocHelpers::stringData(
    "ShellProcessTests",
    "initTestCase",
    "",
...
Q_CONSTINIT static const uint qt_meta_data_ZN17ShellProcessTestsE[] = {
...
Q_CONSTINIT const QMetaObject ShellProcessTests::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN17ShellProcessTestsE.offsetsAndSizes,
    qt_meta_data_ZN17ShellProcessTestsE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN17ShellProcessTestsE_t,
        // Q_OBJECT / Q_GADGET
...
void *ShellProcessTests::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN17ShellProcessTestsE.stringdata0))
