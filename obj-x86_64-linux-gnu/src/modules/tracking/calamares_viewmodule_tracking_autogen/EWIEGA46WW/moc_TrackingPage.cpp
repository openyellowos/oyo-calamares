...
static constexpr auto qt_meta_stringdata_ZN12TrackingPageE = QtMocHelpers::stringData(
    "TrackingPage",
    "retranslate",
    "",
    "buttonNoneChecked",
...
Q_CONSTINIT static const uint qt_meta_data_ZN12TrackingPageE[] = {
...
Q_CONSTINIT const QMetaObject TrackingPage::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN12TrackingPageE.offsetsAndSizes,
    qt_meta_data_ZN12TrackingPageE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN12TrackingPageE_t,
        // Q_OBJECT / Q_GADGET
...
void *TrackingPage::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN12TrackingPageE.stringdata0))
