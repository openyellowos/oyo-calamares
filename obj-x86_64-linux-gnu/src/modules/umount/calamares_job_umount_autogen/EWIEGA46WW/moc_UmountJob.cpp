...
static constexpr auto qt_meta_stringdata_ZN9UmountJobE = QtMocHelpers::stringData(
    "UmountJob"
);
...
Q_CONSTINIT static const uint qt_meta_data_ZN9UmountJobE[] = {
...
Q_CONSTINIT const QMetaObject UmountJob::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN9UmountJobE.offsetsAndSizes,
    qt_meta_data_ZN9UmountJobE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN9UmountJobE_t,
        // Q_OBJECT / Q_GADGET
...
void *UmountJob::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN9UmountJobE.stringdata0))
...
#ifdef QT_MOC_HAS_STRINGDATA
static constexpr auto qt_meta_stringdata_ZN16UmountJobFactoryE = QtMocHelpers::stringData(
    "UmountJobFactory"
);
#else  // !QT_MOC_HAS_STRINGDATA
#error "qtmochelpers.h not found or too old."
...
Q_CONSTINIT static const uint qt_meta_data_ZN16UmountJobFactoryE[] = {
...
Q_CONSTINIT const QMetaObject UmountJobFactory::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN16UmountJobFactoryE.offsetsAndSizes,
    qt_meta_data_ZN16UmountJobFactoryE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN16UmountJobFactoryE_t,
        // Q_OBJECT / Q_GADGET
...
{
    if (!_clname) return nullptr;
    if (!strcmp(_clname, qt_meta_stringdata_ZN16UmountJobFactoryE.stringdata0))
        return static_cast<void*>(this);
