...
static constexpr auto qt_meta_stringdata_ZN22PackageChooserViewStepE = QtMocHelpers::stringData(
...
Q_CONSTINIT static const uint qt_meta_data_ZN22PackageChooserViewStepE[] = {
...
Q_CONSTINIT const QMetaObject PackageChooserViewStep::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN22PackageChooserViewStepE.offsetsAndSizes,
    qt_meta_data_ZN22PackageChooserViewStepE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN22PackageChooserViewStepE_t,
        // Q_OBJECT / Q_GADGET
...
void *PackageChooserViewStep::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN22PackageChooserViewStepE.stringdata0))
...
#ifdef QT_MOC_HAS_STRINGDATA
static constexpr auto qt_meta_stringdata_ZN29PackageChooserViewStepFactoryE = QtMocHelpers::stringData(
...
Q_CONSTINIT static const uint qt_meta_data_ZN29PackageChooserViewStepFactoryE[] = {
...
Q_CONSTINIT const QMetaObject PackageChooserViewStepFactory::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN29PackageChooserViewStepFactoryE.offsetsAndSizes,
    qt_meta_data_ZN29PackageChooserViewStepFactoryE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN29PackageChooserViewStepFactoryE_t,
        // Q_OBJECT / Q_GADGET
...
{
    if (!_clname) return nullptr;
    if (!strcmp(_clname, qt_meta_stringdata_ZN29PackageChooserViewStepFactoryE.stringdata0))
        return static_cast<void*>(this);
