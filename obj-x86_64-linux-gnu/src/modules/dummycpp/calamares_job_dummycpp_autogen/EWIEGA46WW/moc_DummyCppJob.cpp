...
static constexpr auto qt_meta_stringdata_ZN11DummyCppJobE = QtMocHelpers::stringData(
    "DummyCppJob"
);
...
Q_CONSTINIT static const uint qt_meta_data_ZN11DummyCppJobE[] = {
...
Q_CONSTINIT const QMetaObject DummyCppJob::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN11DummyCppJobE.offsetsAndSizes,
    qt_meta_data_ZN11DummyCppJobE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN11DummyCppJobE_t,
        // Q_OBJECT / Q_GADGET
...
void *DummyCppJob::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN11DummyCppJobE.stringdata0))
...
#ifdef QT_MOC_HAS_STRINGDATA
static constexpr auto qt_meta_stringdata_ZN18DummyCppJobFactoryE = QtMocHelpers::stringData(
    "DummyCppJobFactory"
);
#else  // !QT_MOC_HAS_STRINGDATA
#error "qtmochelpers.h not found or too old."
...
Q_CONSTINIT static const uint qt_meta_data_ZN18DummyCppJobFactoryE[] = {
...
Q_CONSTINIT const QMetaObject DummyCppJobFactory::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN18DummyCppJobFactoryE.offsetsAndSizes,
    qt_meta_data_ZN18DummyCppJobFactoryE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN18DummyCppJobFactoryE_t,
        // Q_OBJECT / Q_GADGET
...
{
    if (!_clname) return nullptr;
    if (!strcmp(_clname, qt_meta_stringdata_ZN18DummyCppJobFactoryE.stringdata0))
        return static_cast<void*>(this);
