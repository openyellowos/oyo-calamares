...
static constexpr auto qt_meta_stringdata_ZN18CreateLayoutsTestsE = QtMocHelpers::stringData(
    "CreateLayoutsTests",
...
Q_CONSTINIT static const uint qt_meta_data_ZN18CreateLayoutsTestsE[] = {
...
Q_CONSTINIT const QMetaObject CreateLayoutsTests::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN18CreateLayoutsTestsE.offsetsAndSizes,
    qt_meta_data_ZN18CreateLayoutsTestsE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN18CreateLayoutsTestsE_t,
        // Q_OBJECT / Q_GADGET
...
void *CreateLayoutsTests::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN18CreateLayoutsTestsE.stringdata0))
