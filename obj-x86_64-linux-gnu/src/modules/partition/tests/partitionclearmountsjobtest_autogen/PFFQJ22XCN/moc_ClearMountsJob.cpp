...
static constexpr auto qt_meta_stringdata_ZN14ClearMountsJobE = QtMocHelpers::stringData(
    "ClearMountsJob"
);
...
Q_CONSTINIT static const uint qt_meta_data_ZN14ClearMountsJobE[] = {
...
Q_CONSTINIT const QMetaObject ClearMountsJob::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN14ClearMountsJobE.offsetsAndSizes,
    qt_meta_data_ZN14ClearMountsJobE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN14ClearMountsJobE_t,
        // Q_OBJECT / Q_GADGET
...
void *ClearMountsJob::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN14ClearMountsJobE.stringdata0))
