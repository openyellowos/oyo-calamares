...
static constexpr auto qt_meta_stringdata_ZN12PartitionJobE = QtMocHelpers::stringData(
    "PartitionJob",
    "iprogress",
    "",
    "percent"
...
Q_CONSTINIT static const uint qt_meta_data_ZN12PartitionJobE[] = {
...
Q_CONSTINIT const QMetaObject PartitionJob::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN12PartitionJobE.offsetsAndSizes,
    qt_meta_data_ZN12PartitionJobE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN12PartitionJobE_t,
        // Q_OBJECT / Q_GADGET
...
void *PartitionJob::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN12PartitionJobE.stringdata0))
