...
static constexpr auto qt_meta_stringdata_ZN17PartitionViewStepE = QtMocHelpers::stringData(
    "PartitionViewStep"
);
...
Q_CONSTINIT static const uint qt_meta_data_ZN17PartitionViewStepE[] = {
...
Q_CONSTINIT const QMetaObject PartitionViewStep::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN17PartitionViewStepE.offsetsAndSizes,
    qt_meta_data_ZN17PartitionViewStepE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN17PartitionViewStepE_t,
        // Q_OBJECT / Q_GADGET
...
void *PartitionViewStep::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN17PartitionViewStepE.stringdata0))
...
#ifdef QT_MOC_HAS_STRINGDATA
static constexpr auto qt_meta_stringdata_ZN24PartitionViewStepFactoryE = QtMocHelpers::stringData(
...
Q_CONSTINIT static const uint qt_meta_data_ZN24PartitionViewStepFactoryE[] = {
...
Q_CONSTINIT const QMetaObject PartitionViewStepFactory::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN24PartitionViewStepFactoryE.offsetsAndSizes,
    qt_meta_data_ZN24PartitionViewStepFactoryE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN24PartitionViewStepFactoryE_t,
        // Q_OBJECT / Q_GADGET
...
{
    if (!_clname) return nullptr;
    if (!strcmp(_clname, qt_meta_stringdata_ZN24PartitionViewStepFactoryE.stringdata0))
        return static_cast<void*>(this);
