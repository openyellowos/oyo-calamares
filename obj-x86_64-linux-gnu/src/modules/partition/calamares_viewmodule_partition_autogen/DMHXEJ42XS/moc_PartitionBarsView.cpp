...
static constexpr auto qt_meta_stringdata_ZN17PartitionBarsViewE = QtMocHelpers::stringData(
    "PartitionBarsView",
    "updateGeometries",
    ""
);
...
Q_CONSTINIT static const uint qt_meta_data_ZN17PartitionBarsViewE[] = {
...
Q_CONSTINIT const QMetaObject PartitionBarsView::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN17PartitionBarsViewE.offsetsAndSizes,
    qt_meta_data_ZN17PartitionBarsViewE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN17PartitionBarsViewE_t,
        // Q_OBJECT / Q_GADGET
...
void *PartitionBarsView::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN17PartitionBarsViewE.stringdata0))
