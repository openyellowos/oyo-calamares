...
static constexpr auto qt_meta_stringdata_ZN14ScanningDialogE = QtMocHelpers::stringData(
    "ScanningDialog",
    "visibilityChanged",
    "",
    "setVisible",
...
Q_CONSTINIT static const uint qt_meta_data_ZN14ScanningDialogE[] = {
...
Q_CONSTINIT const QMetaObject ScanningDialog::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN14ScanningDialogE.offsetsAndSizes,
    qt_meta_data_ZN14ScanningDialogE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN14ScanningDialogE_t,
        // Q_OBJECT / Q_GADGET
...
void ScanningDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        ...
        {
            using _q_method_type = void (ScanningDialog::*)();
            if (_q_method_type _q_method = &ScanningDialog::visibilityChanged; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
void *ScanningDialog::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN14ScanningDialogE.stringdata0))
