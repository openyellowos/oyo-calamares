...
static constexpr auto qt_meta_stringdata_ZN14BootInfoWidgetE = QtMocHelpers::stringData(
    "BootInfoWidget",
    "retranslateUi",
    ""
);
...
Q_CONSTINIT static const uint qt_meta_data_ZN14BootInfoWidgetE[] = {
...
Q_CONSTINIT const QMetaObject BootInfoWidget::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN14BootInfoWidgetE.offsetsAndSizes,
    qt_meta_data_ZN14BootInfoWidgetE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN14BootInfoWidgetE_t,
        // Q_OBJECT / Q_GADGET
...
void *BootInfoWidget::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN14BootInfoWidgetE.stringdata0))
