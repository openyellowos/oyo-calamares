...
static constexpr auto qt_meta_stringdata_ZN23ResizeVolumeGroupDialogE = QtMocHelpers::stringData(
...
Q_CONSTINIT static const uint qt_meta_data_ZN23ResizeVolumeGroupDialogE[] = {
...
Q_CONSTINIT const QMetaObject ResizeVolumeGroupDialog::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN23ResizeVolumeGroupDialogE.offsetsAndSizes,
    qt_meta_data_ZN23ResizeVolumeGroupDialogE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN23ResizeVolumeGroupDialogE_t,
        // Q_OBJECT / Q_GADGET
...
void *ResizeVolumeGroupDialog::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN23ResizeVolumeGroupDialogE.stringdata0))
