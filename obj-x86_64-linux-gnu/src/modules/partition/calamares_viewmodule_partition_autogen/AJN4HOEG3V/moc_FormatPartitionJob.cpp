...
static constexpr auto qt_meta_stringdata_ZN18FormatPartitionJobE = QtMocHelpers::stringData(
    "FormatPartitionJob"
);
...
Q_CONSTINIT static const uint qt_meta_data_ZN18FormatPartitionJobE[] = {
...
Q_CONSTINIT const QMetaObject FormatPartitionJob::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN18FormatPartitionJobE.offsetsAndSizes,
    qt_meta_data_ZN18FormatPartitionJobE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN18FormatPartitionJobE_t,
        // Q_OBJECT / Q_GADGET
...
void *FormatPartitionJob::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN18FormatPartitionJobE.stringdata0))
