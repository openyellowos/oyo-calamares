...
static constexpr auto qt_meta_stringdata_ZN18CreatePartitionJobE = QtMocHelpers::stringData(
    "CreatePartitionJob"
);
...
Q_CONSTINIT static const uint qt_meta_data_ZN18CreatePartitionJobE[] = {
...
Q_CONSTINIT const QMetaObject CreatePartitionJob::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN18CreatePartitionJobE.offsetsAndSizes,
    qt_meta_data_ZN18CreatePartitionJobE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN18CreatePartitionJobE_t,
        // Q_OBJECT / Q_GADGET
...
void *CreatePartitionJob::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN18CreatePartitionJobE.stringdata0))
