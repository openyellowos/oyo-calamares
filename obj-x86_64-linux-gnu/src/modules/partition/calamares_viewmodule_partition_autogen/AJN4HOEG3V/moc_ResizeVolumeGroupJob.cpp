...
static constexpr auto qt_meta_stringdata_ZN20ResizeVolumeGroupJobE = QtMocHelpers::stringData(
...
Q_CONSTINIT static const uint qt_meta_data_ZN20ResizeVolumeGroupJobE[] = {
...
Q_CONSTINIT const QMetaObject ResizeVolumeGroupJob::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN20ResizeVolumeGroupJobE.offsetsAndSizes,
    qt_meta_data_ZN20ResizeVolumeGroupJobE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN20ResizeVolumeGroupJobE_t,
        // Q_OBJECT / Q_GADGET
...
void *ResizeVolumeGroupJob::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN20ResizeVolumeGroupJobE.stringdata0))
