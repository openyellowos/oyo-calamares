...
static constexpr auto qt_meta_stringdata_ZN15SetPartFlagsJobE = QtMocHelpers::stringData(
    "SetPartFlagsJob"
);
...
Q_CONSTINIT static const uint qt_meta_data_ZN15SetPartFlagsJobE[] = {
...
Q_CONSTINIT const QMetaObject SetPartFlagsJob::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN15SetPartFlagsJobE.offsetsAndSizes,
    qt_meta_data_ZN15SetPartFlagsJobE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN15SetPartFlagsJobE_t,
        // Q_OBJECT / Q_GADGET
...
void *SetPartFlagsJob::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN15SetPartFlagsJobE.stringdata0))
