...
static constexpr auto qt_meta_stringdata_ZN18ClearTempMountsJobE = QtMocHelpers::stringData(
    "ClearTempMountsJob"
);
...
Q_CONSTINIT static const uint qt_meta_data_ZN18ClearTempMountsJobE[] = {
...
Q_CONSTINIT const QMetaObject ClearTempMountsJob::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN18ClearTempMountsJobE.offsetsAndSizes,
    qt_meta_data_ZN18ClearTempMountsJobE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN18ClearTempMountsJobE_t,
        // Q_OBJECT / Q_GADGET
...
void *ClearTempMountsJob::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN18ClearTempMountsJobE.stringdata0))
