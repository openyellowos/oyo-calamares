...
static constexpr auto qt_meta_stringdata_ZN13PreserveFilesE = QtMocHelpers::stringData(
    "PreserveFiles"
);
...
Q_CONSTINIT static const uint qt_meta_data_ZN13PreserveFilesE[] = {
...
Q_CONSTINIT const QMetaObject PreserveFiles::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN13PreserveFilesE.offsetsAndSizes,
    qt_meta_data_ZN13PreserveFilesE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN13PreserveFilesE_t,
        // Q_OBJECT / Q_GADGET
...
void *PreserveFiles::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN13PreserveFilesE.stringdata0))
...
#ifdef QT_MOC_HAS_STRINGDATA
static constexpr auto qt_meta_stringdata_ZN20PreserveFilesFactoryE = QtMocHelpers::stringData(
...
Q_CONSTINIT static const uint qt_meta_data_ZN20PreserveFilesFactoryE[] = {
...
Q_CONSTINIT const QMetaObject PreserveFilesFactory::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN20PreserveFilesFactoryE.offsetsAndSizes,
    qt_meta_data_ZN20PreserveFilesFactoryE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN20PreserveFilesFactoryE_t,
        // Q_OBJECT / Q_GADGET
...
{
    if (!_clname) return nullptr;
    if (!strcmp(_clname, qt_meta_stringdata_ZN20PreserveFilesFactoryE.stringdata0))
        return static_cast<void*>(this);
