...
static constexpr auto qt_meta_stringdata_ZN12FinishedPageE = QtMocHelpers::stringData(
    "FinishedPage",
...
Q_CONSTINIT static const uint qt_meta_data_ZN12FinishedPageE[] = {
...
Q_CONSTINIT const QMetaObject FinishedPage::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN12FinishedPageE.offsetsAndSizes,
    qt_meta_data_ZN12FinishedPageE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN12FinishedPageE_t,
        // Q_OBJECT / Q_GADGET
...
void *FinishedPage::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN12FinishedPageE.stringdata0))
