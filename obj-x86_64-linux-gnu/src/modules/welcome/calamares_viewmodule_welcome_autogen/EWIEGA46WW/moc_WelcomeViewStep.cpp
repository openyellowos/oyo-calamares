...
static constexpr auto qt_meta_stringdata_ZN15WelcomeViewStepE = QtMocHelpers::stringData(
    "WelcomeViewStep"
);
...
Q_CONSTINIT static const uint qt_meta_data_ZN15WelcomeViewStepE[] = {
...
Q_CONSTINIT const QMetaObject WelcomeViewStep::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN15WelcomeViewStepE.offsetsAndSizes,
    qt_meta_data_ZN15WelcomeViewStepE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN15WelcomeViewStepE_t,
        // Q_OBJECT / Q_GADGET
...
void *WelcomeViewStep::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN15WelcomeViewStepE.stringdata0))
...
#ifdef QT_MOC_HAS_STRINGDATA
static constexpr auto qt_meta_stringdata_ZN22WelcomeViewStepFactoryE = QtMocHelpers::stringData(
...
Q_CONSTINIT static const uint qt_meta_data_ZN22WelcomeViewStepFactoryE[] = {
...
Q_CONSTINIT const QMetaObject WelcomeViewStepFactory::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN22WelcomeViewStepFactoryE.offsetsAndSizes,
    qt_meta_data_ZN22WelcomeViewStepFactoryE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN22WelcomeViewStepFactoryE_t,
        // Q_OBJECT / Q_GADGET
...
{
    if (!_clname) return nullptr;
    if (!strcmp(_clname, qt_meta_stringdata_ZN22WelcomeViewStepFactoryE.stringdata0))
        return static_cast<void*>(this);
