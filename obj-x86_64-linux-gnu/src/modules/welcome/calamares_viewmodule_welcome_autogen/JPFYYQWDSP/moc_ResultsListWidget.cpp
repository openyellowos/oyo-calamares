...
static constexpr auto qt_meta_stringdata_ZN17ResultsListWidgetE = QtMocHelpers::stringData(
    "ResultsListWidget"
);
...
Q_CONSTINIT static const uint qt_meta_data_ZN17ResultsListWidgetE[] = {
...
Q_CONSTINIT const QMetaObject ResultsListWidget::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN17ResultsListWidgetE.offsetsAndSizes,
    qt_meta_data_ZN17ResultsListWidgetE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN17ResultsListWidgetE_t,
        // Q_OBJECT / Q_GADGET
...
void *ResultsListWidget::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN17ResultsListWidgetE.stringdata0))
