...
static constexpr auto qt_meta_stringdata_ZN16CheckerContainerE = QtMocHelpers::stringData(
    "CheckerContainer",
...
Q_CONSTINIT static const uint qt_meta_data_ZN16CheckerContainerE[] = {
...
Q_CONSTINIT const QMetaObject CheckerContainer::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN16CheckerContainerE.offsetsAndSizes,
    qt_meta_data_ZN16CheckerContainerE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN16CheckerContainerE_t,
        // Q_OBJECT / Q_GADGET
...
void *CheckerContainer::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN16CheckerContainerE.stringdata0))
