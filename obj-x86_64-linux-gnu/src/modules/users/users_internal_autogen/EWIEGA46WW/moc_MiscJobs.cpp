...
static constexpr auto qt_meta_stringdata_ZN12SetupSudoJobE = QtMocHelpers::stringData(
    "SetupSudoJob"
);
...
Q_CONSTINIT static const uint qt_meta_data_ZN12SetupSudoJobE[] = {
...
Q_CONSTINIT const QMetaObject SetupSudoJob::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN12SetupSudoJobE.offsetsAndSizes,
    qt_meta_data_ZN12SetupSudoJobE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN12SetupSudoJobE_t,
        // Q_OBJECT / Q_GADGET
...
void *SetupSudoJob::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN12SetupSudoJobE.stringdata0))
...
#ifdef QT_MOC_HAS_STRINGDATA
static constexpr auto qt_meta_stringdata_ZN14SetupGroupsJobE = QtMocHelpers::stringData(
    "SetupGroupsJob"
);
#else  // !QT_MOC_HAS_STRINGDATA
#error "qtmochelpers.h not found or too old."
...
Q_CONSTINIT static const uint qt_meta_data_ZN14SetupGroupsJobE[] = {
...
Q_CONSTINIT const QMetaObject SetupGroupsJob::staticMetaObject = { {
    QMetaObject::SuperData::link<Calamares::Job::staticMetaObject>(),
    qt_meta_stringdata_ZN14SetupGroupsJobE.offsetsAndSizes,
    qt_meta_data_ZN14SetupGroupsJobE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN14SetupGroupsJobE_t,
        // Q_OBJECT / Q_GADGET
...
{
    if (!_clname) return nullptr;
    if (!strcmp(_clname, qt_meta_stringdata_ZN14SetupGroupsJobE.stringdata0))
        return static_cast<void*>(this);
    return Calamares::Job::qt_metacast(_clname);
}
