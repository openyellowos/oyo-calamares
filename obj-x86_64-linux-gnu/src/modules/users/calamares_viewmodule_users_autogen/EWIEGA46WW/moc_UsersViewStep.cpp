...
static constexpr auto qt_meta_stringdata_ZN13UsersViewStepE = QtMocHelpers::stringData(
    "UsersViewStep"
);
...
Q_CONSTINIT static const uint qt_meta_data_ZN13UsersViewStepE[] = {
...
Q_CONSTINIT const QMetaObject UsersViewStep::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN13UsersViewStepE.offsetsAndSizes,
    qt_meta_data_ZN13UsersViewStepE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN13UsersViewStepE_t,
        // Q_OBJECT / Q_GADGET
...
void *UsersViewStep::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN13UsersViewStepE.stringdata0))
...
#ifdef QT_MOC_HAS_STRINGDATA
static constexpr auto qt_meta_stringdata_ZN20UsersViewStepFactoryE = QtMocHelpers::stringData(
...
Q_CONSTINIT static const uint qt_meta_data_ZN20UsersViewStepFactoryE[] = {
...
Q_CONSTINIT const QMetaObject UsersViewStepFactory::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN20UsersViewStepFactoryE.offsetsAndSizes,
    qt_meta_data_ZN20UsersViewStepFactoryE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN20UsersViewStepFactoryE_t,
        // Q_OBJECT / Q_GADGET
...
{
    if (!_clname) return nullptr;
    if (!strcmp(_clname, qt_meta_stringdata_ZN20UsersViewStepFactoryE.stringdata0))
        return static_cast<void*>(this);
