...
static constexpr auto qt_meta_stringdata_ZN14SetPasswordJobE = QtMocHelpers::stringData(
    "SetPasswordJob"
);
...
Q_CONSTINIT static const uint qt_meta_data_ZN14SetPasswordJobE[] = {
...
Q_CONSTINIT const QMetaObject SetPasswordJob::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN14SetPasswordJobE.offsetsAndSizes,
    qt_meta_data_ZN14SetPasswordJobE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN14SetPasswordJobE_t,
        // Q_OBJECT / Q_GADGET
...
void *SetPasswordJob::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN14SetPasswordJobE.stringdata0))
