...
static constexpr auto qt_meta_stringdata_ZN18SummaryQmlViewStepE = QtMocHelpers::stringData(
    "SummaryQmlViewStep"
);
...
Q_CONSTINIT static const uint qt_meta_data_ZN18SummaryQmlViewStepE[] = {
...
Q_CONSTINIT const QMetaObject SummaryQmlViewStep::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN18SummaryQmlViewStepE.offsetsAndSizes,
    qt_meta_data_ZN18SummaryQmlViewStepE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN18SummaryQmlViewStepE_t,
        // Q_OBJECT / Q_GADGET
...
void *SummaryQmlViewStep::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN18SummaryQmlViewStepE.stringdata0))
...
#ifdef QT_MOC_HAS_STRINGDATA
static constexpr auto qt_meta_stringdata_ZN25SummaryQmlViewStepFactoryE = QtMocHelpers::stringData(
...
Q_CONSTINIT static const uint qt_meta_data_ZN25SummaryQmlViewStepFactoryE[] = {
...
Q_CONSTINIT const QMetaObject SummaryQmlViewStepFactory::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN25SummaryQmlViewStepFactoryE.offsetsAndSizes,
    qt_meta_data_ZN25SummaryQmlViewStepFactoryE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN25SummaryQmlViewStepFactoryE_t,
        // Q_OBJECT / Q_GADGET
...
{
    if (!_clname) return nullptr;
    if (!strcmp(_clname, qt_meta_stringdata_ZN25SummaryQmlViewStepFactoryE.stringdata0))
        return static_cast<void*>(this);
