...
static constexpr auto qt_meta_stringdata_ZN9Calamares17ExecutionViewStepE = QtMocHelpers::stringData(
...
Q_CONSTINIT static const uint qt_meta_data_ZN9Calamares17ExecutionViewStepE[] = {
...
Q_CONSTINIT const QMetaObject Calamares::ExecutionViewStep::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN9Calamares17ExecutionViewStepE.offsetsAndSizes,
    qt_meta_data_ZN9Calamares17ExecutionViewStepE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN9Calamares17ExecutionViewStepE_t,
        // Q_OBJECT / Q_GADGET
...
void *Calamares::ExecutionViewStep::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN9Calamares17ExecutionViewStepE.stringdata0))
