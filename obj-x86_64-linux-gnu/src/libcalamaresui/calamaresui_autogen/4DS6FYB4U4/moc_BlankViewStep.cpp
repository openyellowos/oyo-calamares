...
static constexpr auto qt_meta_stringdata_ZN9Calamares13BlankViewStepE = QtMocHelpers::stringData(
...
Q_CONSTINIT static const uint qt_meta_data_ZN9Calamares13BlankViewStepE[] = {
...
Q_CONSTINIT const QMetaObject Calamares::BlankViewStep::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN9Calamares13BlankViewStepE.offsetsAndSizes,
    qt_meta_data_ZN9Calamares13BlankViewStepE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN9Calamares13BlankViewStepE_t,
        // Q_OBJECT / Q_GADGET
...
void *Calamares::BlankViewStep::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN9Calamares13BlankViewStepE.stringdata0))
