...
static constexpr auto qt_meta_stringdata_ZN9Calamares8ViewStepE = QtMocHelpers::stringData(
    "Calamares::ViewStep",
    "nextStatusChanged",
    "",
    "status",
...
Q_CONSTINIT static const uint qt_meta_data_ZN9Calamares8ViewStepE[] = {
...
Q_CONSTINIT const QMetaObject Calamares::ViewStep::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN9Calamares8ViewStepE.offsetsAndSizes,
    qt_meta_data_ZN9Calamares8ViewStepE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN9Calamares8ViewStepE_t,
        // Q_OBJECT / Q_GADGET
...
void Calamares::ViewStep::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        ...
        {
            using _q_method_type = void (ViewStep::*)(bool );
            if (_q_method_type _q_method = &ViewStep::nextStatusChanged; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
        {
            using _q_method_type = void (ViewStep::*)(QSize ) const;
            if (_q_method_type _q_method = &ViewStep::ensureSize; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 1;
                return;
            }
        }
...
void *Calamares::ViewStep::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN9Calamares8ViewStepE.stringdata0))
