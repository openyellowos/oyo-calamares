...
static constexpr auto qt_meta_stringdata_ZN9Calamares13ModuleManagerE = QtMocHelpers::stringData(
...
Q_CONSTINIT static const uint qt_meta_data_ZN9Calamares13ModuleManagerE[] = {
...
Q_CONSTINIT const QMetaObject Calamares::ModuleManager::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN9Calamares13ModuleManagerE.offsetsAndSizes,
    qt_meta_data_ZN9Calamares13ModuleManagerE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN9Calamares13ModuleManagerE_t,
        // Q_OBJECT / Q_GADGET
...
void Calamares::ModuleManager::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        ...
        {
            using _q_method_type = void (ModuleManager::*)();
            if (_q_method_type _q_method = &ModuleManager::initDone; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
        {
            using _q_method_type = void (ModuleManager::*)();
            if (_q_method_type _q_method = &ModuleManager::modulesLoaded; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 1;
                return;
            }
        }
        {
            using _q_method_type = void (ModuleManager::*)(QStringList );
            if (_q_method_type _q_method = &ModuleManager::modulesFailed; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 2;
                return;
            }
        }
        {
            using _q_method_type = void (ModuleManager::*)(bool );
            if (_q_method_type _q_method = &ModuleManager::requirementsComplete; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 3;
                return;
            }
        }
...
void *Calamares::ModuleManager::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN9Calamares13ModuleManagerE.stringdata0))
