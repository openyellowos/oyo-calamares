...
static constexpr auto qt_meta_stringdata_ZN21FixedAspectRatioLabelE = QtMocHelpers::stringData(
...
Q_CONSTINIT static const uint qt_meta_data_ZN21FixedAspectRatioLabelE[] = {
...
Q_CONSTINIT const QMetaObject FixedAspectRatioLabel::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN21FixedAspectRatioLabelE.offsetsAndSizes,
    qt_meta_data_ZN21FixedAspectRatioLabelE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN21FixedAspectRatioLabelE_t,
        // Q_OBJECT / Q_GADGET
...
void *FixedAspectRatioLabel::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN21FixedAspectRatioLabelE.stringdata0))
