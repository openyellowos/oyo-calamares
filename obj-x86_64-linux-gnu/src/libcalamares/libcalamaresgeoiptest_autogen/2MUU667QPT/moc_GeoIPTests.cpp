...
static constexpr auto qt_meta_stringdata_ZN10GeoIPTestsE = QtMocHelpers::stringData(
    "GeoIPTests",
    "initTestCase",
    "",
    "testFixed",
...
Q_CONSTINIT static const uint qt_meta_data_ZN10GeoIPTestsE[] = {
...
Q_CONSTINIT const QMetaObject GeoIPTests::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN10GeoIPTestsE.offsetsAndSizes,
    qt_meta_data_ZN10GeoIPTestsE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN10GeoIPTestsE_t,
        // Q_OBJECT / Q_GADGET
...
void *GeoIPTests::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN10GeoIPTestsE.stringdata0))
