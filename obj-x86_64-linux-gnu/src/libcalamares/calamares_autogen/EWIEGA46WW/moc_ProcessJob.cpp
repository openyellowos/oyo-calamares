...
static constexpr auto qt_meta_stringdata_ZN9Calamares10ProcessJobE = QtMocHelpers::stringData(
...
Q_CONSTINIT static const uint qt_meta_data_ZN9Calamares10ProcessJobE[] = {
...
Q_CONSTINIT const QMetaObject Calamares::ProcessJob::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN9Calamares10ProcessJobE.offsetsAndSizes,
    qt_meta_data_ZN9Calamares10ProcessJobE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN9Calamares10ProcessJobE_t,
        // Q_OBJECT / Q_GADGET
...
void *Calamares::ProcessJob::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN9Calamares10ProcessJobE.stringdata0))
