...
static constexpr auto qt_meta_stringdata_ZN9Calamares3JobE = QtMocHelpers::stringData(
    "Calamares::Job",
    "progress",
    "",
    "percent"
...
Q_CONSTINIT static const uint qt_meta_data_ZN9Calamares3JobE[] = {
...
Q_CONSTINIT const QMetaObject Calamares::Job::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN9Calamares3JobE.offsetsAndSizes,
    qt_meta_data_ZN9Calamares3JobE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN9Calamares3JobE_t,
        // Q_OBJECT / Q_GADGET
...
void Calamares::Job::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        ...
        {
            using _q_method_type = void (Job::*)(qreal );
            if (_q_method_type _q_method = &Job::progress; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
void *Calamares::Job::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN9Calamares3JobE.stringdata0))
