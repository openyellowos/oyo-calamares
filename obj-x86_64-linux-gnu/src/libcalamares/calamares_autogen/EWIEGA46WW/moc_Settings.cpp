...
static constexpr auto qt_meta_stringdata_ZN9Calamares8SettingsE = QtMocHelpers::stringData(
    "Calamares::Settings"
);
...
Q_CONSTINIT static const uint qt_meta_data_ZN9Calamares8SettingsE[] = {
...
Q_CONSTINIT const QMetaObject Calamares::Settings::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN9Calamares8SettingsE.offsetsAndSizes,
    qt_meta_data_ZN9Calamares8SettingsE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN9Calamares8SettingsE_t,
        // Q_OBJECT / Q_GADGET
...
void *Calamares::Settings::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN9Calamares8SettingsE.stringdata0))
