...
static constexpr auto qt_meta_stringdata_ZN9Calamares19RequirementsCheckerE = QtMocHelpers::stringData(
...
Q_CONSTINIT static const uint qt_meta_data_ZN9Calamares19RequirementsCheckerE[] = {
...
Q_CONSTINIT const QMetaObject Calamares::RequirementsChecker::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN9Calamares19RequirementsCheckerE.offsetsAndSizes,
    qt_meta_data_ZN9Calamares19RequirementsCheckerE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN9Calamares19RequirementsCheckerE_t,
        // Q_OBJECT / Q_GADGET
...
void Calamares::RequirementsChecker::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        ...
        {
            using _q_method_type = void (RequirementsChecker::*)(const QString & );
            if (_q_method_type _q_method = &RequirementsChecker::requirementsProgress; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
        {
            using _q_method_type = void (RequirementsChecker::*)();
            if (_q_method_type _q_method = &RequirementsChecker::done; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 1;
                return;
            }
        }
...
void *Calamares::RequirementsChecker::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN9Calamares19RequirementsCheckerE.stringdata0))
