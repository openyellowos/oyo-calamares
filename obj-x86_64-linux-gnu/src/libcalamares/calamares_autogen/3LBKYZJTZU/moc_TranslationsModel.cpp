...
static constexpr auto qt_meta_stringdata_ZN9Calamares6Locale17TranslationsModelE = QtMocHelpers::stringData(
...
Q_CONSTINIT static const uint qt_meta_data_ZN9Calamares6Locale17TranslationsModelE[] = {
...
Q_CONSTINIT const QMetaObject Calamares::Locale::TranslationsModel::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN9Calamares6Locale17TranslationsModelE.offsetsAndSizes,
    qt_meta_data_ZN9Calamares6Locale17TranslationsModelE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN9Calamares6Locale17TranslationsModelE_t,
        // Q_OBJECT / Q_GADGET
...
void *Calamares::Locale::TranslationsModel::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN9Calamares6Locale17TranslationsModelE.stringdata0))
