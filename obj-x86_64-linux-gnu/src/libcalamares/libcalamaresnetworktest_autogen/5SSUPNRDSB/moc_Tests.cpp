...
static constexpr auto qt_meta_stringdata_ZN12NetworkTestsE = QtMocHelpers::stringData(
    "NetworkTests",
    "initTestCase",
    "",
    "testInstance",
...
Q_CONSTINIT static const uint qt_meta_data_ZN12NetworkTestsE[] = {
...
Q_CONSTINIT const QMetaObject NetworkTests::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN12NetworkTestsE.offsetsAndSizes,
    qt_meta_data_ZN12NetworkTestsE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN12NetworkTestsE_t,
        // Q_OBJECT / Q_GADGET
...
void *NetworkTests::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN12NetworkTestsE.stringdata0))
