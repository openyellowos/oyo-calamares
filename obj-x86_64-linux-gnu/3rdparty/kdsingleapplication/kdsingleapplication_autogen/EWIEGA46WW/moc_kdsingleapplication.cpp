...
static constexpr auto qt_meta_stringdata_ZN19KDSingleApplicationE = QtMocHelpers::stringData(
    "KDSingleApplication",
    "messageReceived",
    "",
    "message",
...
Q_CONSTINIT static const uint qt_meta_data_ZN19KDSingleApplicationE[] = {
...
Q_CONSTINIT const QMetaObject KDSingleApplication::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN19KDSingleApplicationE.offsetsAndSizes,
    qt_meta_data_ZN19KDSingleApplicationE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN19KDSingleApplicationE_t,
        // property 'name'
...
void KDSingleApplication::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        ...
        {
            using _q_method_type = void (KDSingleApplication::*)(const QByteArray & );
            if (_q_method_type _q_method = &KDSingleApplication::messageReceived; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
void *KDSingleApplication::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN19KDSingleApplicationE.stringdata0))
